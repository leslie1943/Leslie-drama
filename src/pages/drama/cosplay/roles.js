...
export default {
    // 剧本
    dramas: ['19.坠入深渊', '18.南越王陵', '17.反光', '16.幽灵群岛', '15.业火馆', '14.狼人之血', '13.校园灵异', '12.上海滩杀人', '11.皂罗袍', '10.大明青龙劫', '9.记忆碎片', '8.儿童劫', '7.苍笙九剑', '6.大胥秘史', '5.星座怪谈', '4.盖弥书院', '3.良辰吉日', '2.孽海疑云', '1.蛊魂铃'],
    // 玩家
    persons: [
        { id: 'Dong', name: '老板', avatar: dongdong, participant: '18/19' },
        { id: 'Justin', name: '郭磊', avatar: justin, participant: '17/19' },
        { id: 'Neo', name: '周游', avatar: neo, participant: '18/19' },
        { id: 'Ying', name: '颖姐', avatar: ying, participant: '15/19' },
        { id: 'Mark', name: '马克', avatar: mark, participant: '19/19' },
        { id: 'Dora', name: '雪莲', avatar: dora, participant: '19/19' },
        { id: 'Leslie', name: '苏震', avatar: leslie, participant: '18/19' },
        { id: 'Samantha', name: '慧莹', avatar: samantha, participant: '9/19' }],
    // 列表数据
    results: {
        ...dongdong_drama,
        ...justin_drama,
