  ...
  dramas: [
    ...
    // -------------------------- 狼人之血
    {
      ...
      roles: [
        ...
        { realName: "周游", cosName: "小男孩-卢卡斯" },
        { realName: "颖姐", cosName: "小红帽-凯瑟琳" },
        { realName: "雪莲", cosName: "巫婆" },
        { realName: "苏震", cosName: "医师-皮特" },
        { realName: "马克", cosName: "主持人" },
        { realName: "慧莹", cosName: "灵媒" },
      ],
      status: 2,
      places: ["海帝乐园"],
      ending: {
        ...
        detail: [
          { index: 1, desc: "Mark主持好评,继续保持！👍👍👍👍👍👍" },
          { index: 2, desc: "春节前最后一个本,大家状态很好,很放松." },
          { index: 3, desc: "老板藏的很好." },
          { index: 4, desc: "周游带的很偏." },
          { index: 5, desc: "皮特非常地冤." },
          { index: 6, desc: "几个女玩家省略." },
        ]
      },
    },
    // -------------------------- 狼人之血
    {
      name: "业火馆", persons: 6, copyright: true, type: "xx",
      host: "老板",
      roles: [
        { realName: "老板", cosName: "主持人" },
        { realName: "郭磊", cosName: "阿朴(piao)" },
        { realName: "周游", cosName: "吴又樊" },
        { realName: "颖姐", cosName: "白獠儿" },
        { realName: "雪莲", cosName: "赵兮儿" },
        { realName: "苏震", cosName: "冯越伦" },
        { realName: "马克", cosName: "陆劲" },
        // { realName: "慧莹", cosName: "xxxxxx" },
      ],
      status: 2,
      places: ["海帝乐园"],
      ending: {
        ...
        detail: [
          { index: 1, desc: "老板主持好评,继续保持！👍👍👍👍👍👍" },
          { index: 2, desc: "春节后第一本,大家状态依旧火热" },
          { index: 3, desc: "推算杀人手法,丝毫不差." },
          { index: 4, desc: "忽略了日记本的时间线索是没能破案的主要原因." },
          { index: 5, desc: "我就想问问以后吃饭AA行不行！！！" },
        ]
      },
    },
    ...
    // -------------------------- 幽灵群岛
    {
      name: "幽灵群岛", persons: 6, copyright: true, type: "xx",
      host: "老板",
      roles: [
        { realName: "老板", cosName: "主持人" },
        { realName: "郭磊", cosName: "牧文" },
        { realName: "周游", cosName: "展红" },
        { realName: "颖姐", cosName: "梓晴" },
        { realName: "雪莲", cosName: "佳琪" },
        { realName: "苏震", cosName: "小故" },
        { realName: "马克", cosName: "童木" },
        // { realName: "慧莹", cosName: "xxxxxx" },
      ],
      status: 2,
      places: ["海帝乐园"],
      ending: {
        ...
        detail: [
          { index: 1, desc: "老板主持好评,继续保持！👍👍👍👍👍👍" },
          { index: 2, desc: "一帮直男直女玩这样的文艺煽情本有点过分了" },
          { index: 3, desc: "大家都基本上处于懵逼的状态" },
          { index: 4, desc: "周游真实写照本,有钱，帅，会打球，星途宇宙" },
        ]
      },
    },
    // -------------------------- 反光
    {
      name: "反光", persons: 6, copyright: true, type: "xx",
      host: "Dora",
      roles: [
        { realName: "老板", cosName: "罗善英" },
        { realName: "郭磊", cosName: "应梨儿" },
        { realName: "周游", cosName: "冯义" },
        { realName: "颖姐", cosName: "江雪" },
        { realName: "雪莲", cosName: "主持人" },
        { realName: "苏震", cosName: "裴志虎" },
        { realName: "马克", cosName: "罗天养" },
        // { realName: "慧莹", cosName: "xxxxxx" },
      ],
      status: 2,
      places: ["海帝乐园"],
      ending: {
        ...
        voteMurder: "无",
        detail: [
          { index: 0, desc: "绝对惊艳的一个本，继蛊魂铃之后体验感最深的一个本子" },
          { index: 1, desc: "雪莲同学的第一次主持,非常好,继续保持！👍👍👍👍👍👍" },
          { index: 2, desc: "罗善英: 主动带节奏给自己招来了4票，比不了比不了" },
          { index: 3, desc: "应梨儿: 继马修之后第二次重口味,SM爱好者，比不了比不了" },
          { index: 4, desc: "冯义: 和马克同学打的这配合天衣无缝," },
